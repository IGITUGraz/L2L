...
logger = logging.getLogger(u"optimizers.simulatedannealing")
...
class SimulatedAnnealingOptimizer(Optimizer):
    ...
    def __init__(self, traj,
        ...
        traj.f_add_parameter(u'temp_decay', parameters.temp_decay,
                             comment=u'A temperature decay parameter (multiplicative)')
        ...
        traj.f_add_parameter(u'seed', np.uint32(parameters.seed), comment=u'Seed for RNG')
    ...
    def end(self, traj):
        ...
        logger.info(u"-- End of (successful) annealing --")
