...
def main():
    ...
    optimizers = [
        ...
        (GeneticAlgorithmOptimizer,
         lambda: GeneticAlgorithmParameters(seed=0, popsize=50, CXPB=0.5,
                                            MUTPB=1.0, NGEN=100, indpb=0.01,
                                            tournsize=15, matepar=0.5,
                                            mutpar=1, remutate=False))
    ]
