...
from ltl.optimizees.rbfs.optimizee import RBFOptimizee
...
logger = logging.getLogger('ltl-rbf-sa')


def main():
    name = 'LTL-RBF-SA'
    root_dir_path = "/home/sinisa/Uni/Project_CI/LTL/results"  # CHANGE THIS to the directory where your simulation results are contained
    ...
    optimizee = RBFOptimizee(traj, rbf_params, 2)
